;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH BAEE', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU BAE PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO CEMANGATSS', 'BAE PASTI BISA', 'IHHH BAE KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YAUDAH DEH', 'I', 'LOVE', 'YOU BAEEE♡', 'DADAH', 'MAAFIN AKU YA BAEEEE', 'KALO AKU BIKIN BAEE SEDIKIT KESAL','CEMANGATSS MAGANGNYA DADAHHH']
